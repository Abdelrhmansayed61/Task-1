...
double cost = (smallcarpetsnumber * pricepersmallcarpet) + (largecarpetsnumber * priceperlargecarpet);
...
Console.WriteLine($"Price per small room: {pricepersmallcarpet}");
Console.WriteLine($"Price per large room: {priceperlargecarpet}");
